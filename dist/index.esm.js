...
var Cropper = function (_a) {
    ...
    var _j = useState({ width: width, height: height }), cropSize = _j[0], setCropSize = _j[1];
    var _k = useState({ width: 0, height: 0 }), imageSize = _k[0], setImageSize = _k[1];
    var _l = useState(1), ratio = _l[0], setRatio = _l[1];
    var _m = useState({ x: 0, y: 0 }), crop = _m[0], setCrop = _m[1];
    var _o = useState(false), onEvent = _o[0], setOnEvent = _o[1];
    var _p = useState(false), completeInitial = _p[0], setCompleteInitial = _p[1];
    var cropRef = useRef({ x: 0, y: 0 });
    var zoomRef = useRef(1);
    var imageSizeRef = useRef({ width: 0, height: 0 });
    var containerRef = useRef(null);
    var imageRef = useRef(null);
    var rafDragTimeout = useRef();
    var rafPinchTimeout = useRef();
    var dragStartPosition = useRef({ x: 0, y: 0 });
    ...
    return (React.createElement("div", { className: "cropper-container", ref: containerRef, onMouseDown: function (e) { return onMouseDown(e); }, onTouchStart: function (e) { return onTouchStart(e); }, onWheel: function (e) { return onWheel(e); }, style: {
        ...
        React.createElement("div", { className: "cropper-image", ref: imageRef, style: {
        ...
        React.createElement("div", { className: "cropper-area", style: { display: "".concat(onEvent ? 'block' : 'none') } })));
};
